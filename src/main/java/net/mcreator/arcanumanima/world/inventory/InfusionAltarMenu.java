...
package net.mcreator.arcanumanima.world.inventory;
...
public class InfusionAltarMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public InfusionAltarMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ArcanumAnimaModMenus.INFUSION_ALTAR_GUI.get(), id);
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 25, 88) {
		}));
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 133, 88) {
		}));
