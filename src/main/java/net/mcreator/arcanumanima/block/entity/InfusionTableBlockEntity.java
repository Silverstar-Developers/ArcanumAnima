package net.mcreator.arcanumanima.block.entity;
...
public class InfusionTableBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public InfusionTableBlockEntity(BlockPos position, BlockState state) {
		super(ArcanumAnimaModBlockEntities.INFUSION_TABLE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("infusion_table");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new InfusionAltarMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Infusion Altar");
	}
